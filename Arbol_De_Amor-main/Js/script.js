...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Lizeth Montserrat:\n\nHoy 14 de febrero no puedo estar contigo como quisiera, pero no quería dejar pasar el día sin decirte que, a pesar de todo lo que estamos atravesando, valoro lo que hemos compartido. Gracias por los momentos, por lo aprendido y por lo vivido. Pase lo que pase, deseo que hoy sientas cuánto significas para mí.\n\nTe amo y siempre estarás en mi corazón.`;  } else {
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2025-05-16T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-05-16T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Llevamos hablando: <b>${days}</b> días<br>` +
      `Nuestro aniversario desde ese primer mensaje: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
